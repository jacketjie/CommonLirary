...
//        mViewPager.setPageTransformer(true, new DepthPageTransformer());
    ...
    private void createIndicator() {
        if (needIndicator) {
            ...
            FrameLayout.LayoutParams flp = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT, Gravity.CENTER_HORIZONTAL | Gravity.BOTTOM);
            flp.bottomMargin = DensityUtils.dp2px(getContext(), 10);
